												...
												<div class="card-body">
													...
													<div class="card">
														<div class="position-relative">
															<img class="card-img-top d-block" src="<?php echo base_url()."assets/"; ?>dist/img/cropper.jpg" alt="Card image cap">
												...
												<div class="card card-profile-feed mb-0 rounded-bottom-0">
													<div class="card-header card-header-action">
														<div class="media align-items-center">
															<div class="media-img-wrap d-flex mr-10">
																<div class="avatar avatar-sm">
																	<img src="<?php echo base_url()."assets/"; ?>dist/img/avatar3.jpg" alt="user" class="avatar-img rounded-circle">
																</div>
															</div>
															<div class="media-body">
														...
														<div class="media">
															<div class="media-img-wrap d-flex mr-10">
																<div class="avatar avatar-xs">
																	<img src="<?php echo base_url()."assets/"; ?>dist/img/avatar5.jpg" alt="user" class="avatar-img rounded-circle">
																</div>
															</div>
															<div class="media-body">
													...
													<div class="card-footer">
														<div class="media w-100 align-items-center">
															<div class="media-img-wrap d-flex mr-15">
																<div class="avatar avatar-xs">
																	<img src="<?php echo base_url()."assets/"; ?>dist/img/avatar11.jpg" alt="user" class="avatar-img rounded-circle">
																</div>
															</div>
															<div class="media-body">
											...
											<div class="card card-profile-feed">
                                                <div class="card-header card-header-action">
													<div class="media align-items-center">
														<div class="media-img-wrap d-flex mr-10">
															<div class="avatar avatar-sm">
																<img src="<?php echo base_url()."assets/"; ?>dist/img/avatar6.jpg" alt="user" class="avatar-img rounded-circle">
															</div>
														</div>
														<div class="media-body">
												...
												<div class="card-body">
													...
													<div class="card">
														<div class="position-relative">
															<img class="card-img-top rounded d-block" src="<?php echo base_url()."assets/"; ?>dist/img/slide7.jpg" alt="Card image cap">
												...
												<ul class="list-group list-group-flush">
													...
													<li class="list-group-item border-0">
														<div class="media align-items-center">
															<div class="d-flex media-img-wrap mr-15">
																<div class="avatar avatar-sm">
																	<img src="<?php echo base_url()."assets/"; ?>dist/img/avatar4.jpg" alt="user" class="avatar-img rounded-circle">
																</div>
															</div>
															<div class="media-body">
												...
												<div class="card-body pb-5">
													<div class="hk-row text-center">
														<div class="col-3 mb-15">
															<div class="w-100">
																<img src="<?php echo base_url()."assets/"; ?>dist/img/avatar1.jpg" alt="user" class="img-fluid rounded">
															</div>
															<span class="d-block font-14 text-truncate">Evie Ono</span>
														</div>
														<div class="col-3 mb-15">
															<div class="w-100">
																<img src="<?php echo base_url()."assets/"; ?>dist/img/avatar2.jpg" alt="user" class="img-fluid rounded">
															</div>
															<span class="d-block font-14 text-truncate">Clay Masse</span>
														</div>
														<div class="col-3 mb-15">
															<div class="w-100">
																<img src="<?php echo base_url()."assets/"; ?>dist/img/avatar3.jpg" alt="user" class="img-fluid rounded">
															</div>
															<span class="d-block font-14 text-truncate">Madelyn Rascon</span>
														</div>
														<div class="col-3 mb-15">
															<div class="w-100">
																<img src="<?php echo base_url()."assets/"; ?>dist/img/avatar4.jpg" alt="user" class="img-fluid rounded">
															</div>
															<span class="d-block font-14 text-truncate">Mitsoku Heid</span>
														</div>
														<div class="col-3 mb-15">
															<div class="w-100">
																<img src="<?php echo base_url()."assets/"; ?>dist/img/avatar5.jpg" alt="user" class="img-fluid rounded">
															</div>
															<span class="d-block font-14 text-truncate">Eziquiel Merideth</span>
														</div>
														<div class="col-3 mb-15">
															<div class="w-100">
																<img src="<?php echo base_url()."assets/"; ?>dist/img/avatar6.jpg" alt="user" class="img-fluid rounded">
															</div>
															<span class="d-block font-14 text-truncate">Johnie Metoyer</span>
														</div>
														<div class="col-3 mb-15">
															<div class="w-100">
																<img src="<?php echo base_url()."assets/"; ?>dist/img/avatar7.jpg" alt="user" class="img-fluid rounded">
															</div>
															<span class="d-block font-14 text-truncate">Angelic Lauver</span>
														</div>
														<div class="col-3 mb-15">
															<div class="w-100">
																<img src="<?php echo base_url()."assets/"; ?>dist/img/avatar8.jpg" alt="user" class="img-fluid rounded">
															</div>
												...
												<ul class="list-group list-group-flush">
													<li class="list-group-item border-0">
														<div class="media align-items-center">
															<div class="d-flex media-img-wrap mr-15">
																<div class="avatar avatar-sm">
																	<img src="<?php echo base_url()."assets/"; ?>dist/img/slide1.jpg" alt="user" class="avatar-img rounded-circle">
																</div>
															</div>
															<div class="media-body">
													...
													<li class="list-group-item border-0">
														<div class="media align-items-center">
															<div class="d-flex media-img-wrap mr-15">
																<div class="avatar avatar-sm">
																	<img src="<?php echo base_url()."assets/"; ?>dist/img/slide2.jpg" alt="user" class="avatar-img rounded-circle">
																</div>
															</div>
															<div class="media-body">
													...
													<li class="list-group-item border-0">
														<div class="media align-items-center">
															<div class="d-flex media-img-wrap mr-15">
																<div class="avatar avatar-sm">
																	<img src="<?php echo base_url()."assets/"; ?>dist/img/slide3.jpg" alt="user" class="avatar-img rounded-circle">
																</div>
															</div>
															<div class="media-body">
